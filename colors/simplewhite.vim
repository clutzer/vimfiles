...
" Version:		1.1
" ChangeLog:
" 1.1 2008-09-27 (Christiaan Lutzer)
"   - Made keywords bold
...
hi Statement	guifg=#c00000		guibg=white			gui=bold
hi Statement	ctermfg=darkred		ctermbg=white		cterm=none
hi Comment		guifg=#909090		guibg=white			gui=none
...
hi Type			guifg=#4080ff	 	guibg=white			gui=bold
